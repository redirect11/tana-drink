...
COSA C'È IN QUELL'«ALTRO»

NON SI SA: la cella SPESE del foglio è un numero battuto a mano, senza dettaglio né formula — non c'è niente da leggere.

DA CHIEDERE A FLAVIO, ed è la domanda che decide se questa voce basta: affitto, utenze, SIAE, commercialista sono i sospetti, ma se lì dentro ci fosse anche merce comprata fuori dagli ordini (il volo al cash and carry, il ghiaccio preso al volo) servirebbe un modo di segnarla che non passi dagli ordini fornitore.
