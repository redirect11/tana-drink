...
RESTA TUTTO IL RESTO: cosa fanno i filtri non cambia — cambia solo cosa il numero conta — e restano BUG-058 (terminale nuovo, badge spento: quelle due non le ha nascoste nessuno) e BUG-080 (si somma una per una, e badge e title leggono la stessa lista).
