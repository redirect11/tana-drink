...
Freccia circolare — ricaricare, riprovare, sincronizzare.
...
```jsx
<IconRefresh />                       {/* 1.1em, segue il testo */}
<IconRefresh size="1.4em" />          {/* dentro un tasto grosso */}
<IconRefresh label="Freccia circolare — ricaricare, riprovare, sincronizzare." />         {/* con etichetta: diventa role="img" */}
```
