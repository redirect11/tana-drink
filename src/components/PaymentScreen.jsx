...
import { printScontrino, printFattura, loadPrinterSettings, claimReceiptPrint, reclaimReceiptPrint } from '../lib/printer.js'
...
export default function PaymentScreen({ order: orderProp, settings, onClose, onPaid, onBeforePay, onError, resolveOrderId }) {
  ...
  const closePaid = (incasso = null) => {
    ...
    try {
      ...
      // pagamento che sta succedendo adesso, e se il conto era già stato
      // chiuso e riaperto la copia vecchia non conta più. Senza incasso
      // (chiusure d'ufficio) vale la pretesa normale: una copia e basta.
      if (
        order.id &&
